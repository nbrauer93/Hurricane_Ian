...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 23 12:42:19 2023
...
file = 'RAXPOL-20220929-050344-A154.0-Z.nc'
    #Read in file
...
zh_rescale = np.ones((179,15))*np.nan
s_rescale = np.ones((179,15))*np.nan
height_rescale = np.ones((179,15))*np.nan
...
plt.title(r'RaXPol $154^{o}$ Azimuth $Z_{H}$ 9/29 0503 UTC', size = label_size)
